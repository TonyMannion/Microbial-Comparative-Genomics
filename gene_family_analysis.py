...
if str(args.PATRIC_features) == 'yes':
	median_gene_analysis(args.features_file, 'feature.genome_name', args.feature_type)
...
if str(args.annotations) == 'yes':
	...
	for f in all_filenames:
		os.remove(str(f))
	median_gene_analysis('merged_annotations.txt', 'genome_name', args.feature_type)
