...
These scripts take advantage of the curated database of publicly accessible bacterial genomes and services hosted by [PATRIC](https://www.patricbrc.org/).  
Users of these scripts will require creating a [PATRIC](https://www.patricbrc.org/) account.
